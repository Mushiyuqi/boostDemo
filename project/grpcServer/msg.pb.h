...
PROTOBUF_ALWAYS_INLINE void HelloRequest::set_message(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.message_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:hello.HelloRequest.message)
}
inline std::string* PROTOBUF_NONNULL HelloRequest::mutable_message()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* PROTOBUF_NONNULL HelloRequest::_internal_mutable_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.message_.Mutable( GetArena());
}
inline std::string* PROTOBUF_NULLABLE HelloRequest::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void HelloRequest::set_allocated_message(std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
